            ...
            return (
                <>
                    ...
                    {telaSub === 'Visualizar' ? (
                        ...
                        <FormularioCadastroPet tema={temaCor} setTelaSub={setTelaSub}/>
                    )}
                </>
            );
            ...
            return (
                <>
                    ...
                    {telaSub === 'Visualizar' ? (
                        ...
                        <FormularioCadastroServicos tema={temaCor} setTelaSub={setTelaSub}/>
                    )}
                </>
            );
            ...
            return (
                <>
                    ...
                    {telaSub === 'Visualizar' ? (
                        ...
                        <FormularioCadastroProdutos tema={temaCor} setTelaSub={setTelaSub}/>
                    )}
                </>
            );
        } else {
